...
/*   Updated: 2022/11/09 16:16:43 by joushin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct node_s
{
    enum            node_type_e type; //노드 타입 명령이면 0 ,변수면 1
    enum            val_type_e val_type; //노드가 변수일때 변수 타입
    union           symval_u val;        /* value of this node */
    int             children;            /* number of child nodes */
    struct node_s   *first_child; //부모노드일 때 첫번 째 자식노드에 해당.
